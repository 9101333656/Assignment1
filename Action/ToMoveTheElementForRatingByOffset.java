...
public class ToMoveTheElementForRatingByOffset {
	...
	public static void main(String[] args) {
		...
		WebElement rating1 = driver.findElement(By.cssSelector("input#rating1"));
		Actions action = new Actions(driver);
		action.moveToElement(rating1,150, 0).perform();
